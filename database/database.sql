...
--
-- Host: localhost:3306
-- Generation Time: Jan 13, 2026 at 01:54 PM
...
CREATE TABLE `anlagegueter` (
  ...
  `e1a_kennzahl` enum('9130','9134','9135') COLLATE utf8mb4_general_ci DEFAULT '9130' COMMENT '9130=Normal, 9134=Degressiv, 9135=Gebäude beschleunigt',
...
(1, 'admin', '$2y$10$JjMhTjDKwE13YIuizMQ4RuetXnK4wMerMOqd/MYU.DdZ59mrygoYK', 'admin@example.com', 'System', 'Administrator', 'admin', 1, 0, '2026-01-12 22:01:59', 0, NULL, '2026-01-12 20:44:27', '2026-01-12 21:01:59');
...
CREATE TABLE `einkommensteuer` (
  `id` int NOT NULL,
  `jahr` int NOT NULL,
  `kz9040` decimal(12,2) DEFAULT '0.00' COMMENT 'Erlöse aus Waren/Erzeugnissen',
  `kz9050` decimal(12,2) DEFAULT '0.00' COMMENT 'Erlöse aus Dienstleistungen',
  `kz9100` decimal(12,2) DEFAULT '0.00' COMMENT 'Wareneinkauf/Rohstoffe',
  `kz9110` decimal(12,2) DEFAULT '0.00' COMMENT 'Fremdleistungen (Fremdpersonal)',
  `kz9120` decimal(12,2) DEFAULT '0.00' COMMENT 'Personalaufwand (eigenes Personal)',
  `kz9130` decimal(12,2) DEFAULT '0.00' COMMENT 'AfA normal (linear, GWG)',
  `kz9134` decimal(12,2) DEFAULT '0.00' COMMENT 'Degressive AfA',
  `kz9135` decimal(12,2) DEFAULT '0.00' COMMENT 'Gebäude-AfA beschleunigt',
  `kz9140` decimal(12,2) DEFAULT '0.00' COMMENT 'Betriebsräumlichkeiten',
  `kz9150` decimal(12,2) DEFAULT '0.00' COMMENT 'Sonstige Betriebsausgaben',
...
(1, 'Meine Firma GmbH', 'Musterstraße 1', '1010', 'Wien', '+43 1 234 5678', 'office@meinefirma.at', 'https://stickverliebt.at', 'ATU12345678', '12 345/6789', 'Finanzamt Wien 1/23', '125615131615', 'DNKLFN1651', 'Sparkasse', '01-01', 'quartalsweise', 0, '2026-01-08 07:53:13', '2026-01-08 08:10:15');
...
CREATE TABLE `kategorien` (
  ...
  `e1a_kennzahl` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Zuordnung zur E1a Kennzahl',
  `beschreibung` text COLLATE utf8mb4_general_ci,
...
(1, 'Umsatzerlöse Waren', 'einnahme', '9040', 'Verkauf von Waren und Erzeugnissen', '#28a745', 1, '2026-01-08 07:53:13'),
(2, 'Umsatzerlöse Dienstleistungen', 'einnahme', '9050', 'Einnahmen aus Dienstleistungen', '#20c997', 1, '2026-01-08 07:53:13'),
(3, 'Sonstige Einnahmen', 'einnahme', '9040', 'Provisionen, Nebenerlöse etc.', '#17a2b8', 1, '2026-01-08 07:53:13'),
(4, 'Wareneinkauf', 'ausgabe', '9100', 'Einkauf von Waren und Materialien', '#dc3545', 1, '2026-01-08 07:53:13'),
(5, 'Rohstoffe', 'ausgabe', '9100', 'Rohstoffe und Hilfsstoffe', '#e83e8c', 1, '2026-01-08 07:53:13'),
(6, 'Personalkosten', 'ausgabe', '9120', 'Löhne, Gehälter, Sozialabgaben', '#fd7e14', 1, '2026-01-08 07:53:13'),
(8, 'Miete Büro/Lager', 'ausgabe', '9140', 'Miete für Betriebsräume', '#6c757d', 1, '2026-01-08 07:53:13'),
(9, 'Betriebskosten', 'ausgabe', '9140', 'Strom, Heizung, Wasser', '#795548', 1, '2026-01-08 07:53:13'),
(10, 'Büromaterial', 'ausgabe', '9150', 'Bürobedarf, Druckerkosten', '#607d8b', 1, '2026-01-08 07:53:13'),
(11, 'Telefon/Internet', 'ausgabe', '9150', 'Kommunikationskosten', '#00bcd4', 1, '2026-01-08 07:53:13'),
(12, 'Versicherungen', 'ausgabe', '9150', 'Betriebliche Versicherungen', '#9c27b0', 1, '2026-01-08 07:53:13'),
(13, 'Werbung/Marketing', 'ausgabe', '9200', 'Werbung, Marketing, Website', '#ff5722', 1, '2026-01-08 07:53:13'),
(14, 'Reisekosten', 'ausgabe', '9160', 'Dienstreisen, Hotel, Verpflegung', '#4caf50', 1, '2026-01-08 07:53:13'),
(15, 'KFZ-Kosten', 'ausgabe', '9150', 'Treibstoff, Reparatur, Versicherung', '#2196f3', 1, '2026-01-08 07:53:13'),
(16, 'Fortbildung', 'ausgabe', '9150', 'Kurse, Seminare, Fachliteratur', '#9e9e9e', 1, '2026-01-08 07:53:13'),
(17, 'Bankspesen', 'ausgabe', '9220', 'Kontoführung, Überweisungen', '#455a64', 1, '2026-01-08 07:53:13'),
(18, 'Sonstige Ausgaben', 'ausgabe', '9150', 'Sonstige betriebliche Ausgaben', '#78909c', 1, '2026-01-08 07:53:13'),
(19, 'Fremdleistungen', 'ausgabe', '9110', 'Beigestelltes Personal (Fremdpersonal) und Fremdleistungen', '#e5a61f', 1, '2026-01-13 12:15:23');
...
CREATE TABLE `ust_saetze` (
  ...
  `u30_kennzahl_bemessung` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'U30 Kennzahl für Bemessungsgrundlage',
  `u30_kennzahl_steuer` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'U30 Kennzahl für Steuer',
  `aktiv` tinyint(1) DEFAULT '1',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Normalsteuersatz 20%', '20.00', '022', NULL, 1, '2026-01-08 07:53:13'),
(2, 'Ermäßigt 10%', '10.00', '029', NULL, 1, '2026-01-08 07:53:13'),
(3, 'Ermäßigt 13%', '13.00', '006', NULL, 1, '2026-01-08 07:53:13'),
(4, 'Steuerfrei 0%', '0.00', NULL, NULL, 1, '2026-01-08 07:53:13'),
(5, 'Innergemeinschaftlich', '0.00', '070', '065', 1, '2026-01-08 07:53:13'),
(6, 'Reverse Charge', '0.00', NULL, NULL, 1, '2026-01-08 07:53:13'),
(7, 'EU-Erwerb (igE) 20%', '20.00', '070', '065', 1, '2026-01-13 07:59:32'),
(8, 'Einfuhr-USt Drittland', '20.00', NULL, '061', 1, '2026-01-13 07:59:32'),
(9, 'Ausland (kein VSt-Abzug)', '0.00', NULL, NULL, 1, '2026-01-13 07:59:32');
...
CREATE TABLE `ust_voranmeldungen` (
  ...
  `kz000` decimal(12,2) DEFAULT '0.00' COMMENT 'Gesamtbetrag Lieferungen',
  `kz001` decimal(12,2) DEFAULT '0.00' COMMENT 'Eigenverbrauch',
  `kz021` decimal(12,2) DEFAULT '0.00' COMMENT 'Innergemeinschaftliche Lieferungen (steuerfrei)',
  `kz022` decimal(12,2) DEFAULT '0.00' COMMENT 'Bemessungsgrundlage 20%',
  `kz029` decimal(12,2) DEFAULT '0.00' COMMENT 'USt 20%',
  `kz025` decimal(12,2) DEFAULT '0.00' COMMENT 'Bemessungsgrundlage 10%',
  `kz027` decimal(12,2) DEFAULT '0.00' COMMENT 'USt 10%',
  `kz035` decimal(12,2) DEFAULT '0.00' COMMENT 'Bemessungsgrundlage 13%',
  `kz052` decimal(12,2) DEFAULT '0.00' COMMENT 'USt 13%',
  `kz070` decimal(12,2) DEFAULT '0.00' COMMENT 'Innergemeinschaftliche Erwerbe',
  `kz071` decimal(12,2) DEFAULT '0.00' COMMENT 'USt ig Erwerbe',
  `kz060` decimal(12,2) DEFAULT '0.00' COMMENT 'Vorsteuer gesamt',
  `kz065` decimal(12,2) DEFAULT '0.00' COMMENT 'Vorsteuer aus ig Erwerb',
  `kz066` decimal(12,2) DEFAULT '0.00' COMMENT 'Einfuhrumsatzsteuer',
  `kz082` decimal(12,2) DEFAULT '0.00' COMMENT 'Vorsteuerberichtigung',
  `kz095` decimal(12,2) DEFAULT '0.00' COMMENT 'Zahllast/Gutschrift',
  `zahllast` decimal(12,2) DEFAULT '0.00' COMMENT 'Positiv = Zahllast, Negativ = Gutschrift',
  `eingereicht` tinyint(1) DEFAULT '0',
  `eingereicht_am` date DEFAULT NULL,
  `notizen` text COLLATE utf8mb4_general_ci,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
